...
\geometry{
	hmargin=1.4cm, % Horizontal margin
	vmargin=1.64cm, % Vertical margin
...
\columnratio{0.50,0.50} % The relative ratios of the two columns in the CV
...
\newcommand{\workposition}[5]{
	...
	\expandafter\ifstrequal\expandafter{#4}{}{}{{\raggedright\textbf{#4}}\\[4pt]} % Job title
...
\newcommand{\educationentry}[5]{
	...
	\expandafter\ifstrequal\expandafter{#5}{}{}{& \textit{#5}\\[4pt]} % Institution
}
